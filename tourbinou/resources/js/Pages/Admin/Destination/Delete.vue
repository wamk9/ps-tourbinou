    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <p class="mt-3">Você está prestes a deletar o destino '{{ name }}', deseja continuar?</p>
                <p class="mt-3">Atenção! Além do destino, todos os seus passeios serão deletados automaticamente.</p>
